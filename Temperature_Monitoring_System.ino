...
// WiFi parameters
#define WLAN_SSID       "Vishalsharma"
#define WLAN_PASS       "asdfghjkl"
// Adafruit IO
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883
#define AIO_USERNAME    "VRS22"
#define AIO_KEY         "aio_fhdp05wm5lMrinZjFflIYhSDiR8J" 
WiFiClient client;
...
void loop() {
  ...
  delay(5000);
   ...
   if (! Tempfeed.publish(temp)) {                     //Publish to Adafruit
      Serial.println(F("Failed"));
    } 
       if (! Humidityfeed.publish(hum)) {                     //Publish to Adafruit
      Serial.println(F("Failed"));
    }
    else {
